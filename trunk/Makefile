...
$(BIN_PATH)/process_file_system: $(BUILD_PATH)/pfs.o $(BUILD_PATH)/nipc.o $(BUILD_PATH)/direccionamiento.o
	gcc $(FLAGS) `pkg-config fuse --libs` $(BUILD_PATH)/pfs.o $(BUILD_PATH)/nipc.o $(BUILD_PATH)/direccionamiento.o -o $(BIN_PATH)/process_file_system
